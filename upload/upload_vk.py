...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "✨ Kendall Jenner Daily!\n\n#kendalljenner #hollywood #celebrity #fashion"
        ...
        video = upload.video(
            ...
            name=title or 'Kendall Jenner Daily Video',
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Daily Kendall Jenner Moment! ✨"
    title = sys.argv[3] if len(sys.argv) > 3 else "Kendall Jenner Daily"
